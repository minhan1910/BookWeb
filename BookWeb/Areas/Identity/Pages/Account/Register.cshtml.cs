...
namespace BookWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //if (!_roleManager.RoleExistsAsync(SD.Role_Store_Owner).GetAwaiter().GetResult())
            //{
            //    _roleManager.CreateAsync(new IdentityRole(SD.Role_Store_Owner)).GetAwaiter().GetResult();
            //}
